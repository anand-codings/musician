...
class CreateServiceProfileViewsTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('service_profile_views', function (Blueprint $table) {
    ...
    public function down() {
        Schema::dropIfExists('service_profile_views');
    }
