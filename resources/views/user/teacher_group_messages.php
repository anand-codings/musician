...
<html lang="en">
    ...
    <body>
        ...
        if ($latest_chat && $latest_chat->type == 't') {
            $chat_type = 't';
                                        ...
                                        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title text-black" id="exampleModalLabel">New Group Message to Studio Teachers <span class="text_maroon"> <?= $value['first_name'] . ' ' . $value['last_name']; ?> </span></h6>
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                                        ...
                                                                        if (!empty($studio->teachers)) {
                                                                            foreach ($studio->teachers as $key => $teacher) {
                                                                                if ($teacher->getMemberDetail->id != $current_id) {
                                                                                    ?>
                                                                                    <option <?= ($key == '0') ? 'selected=""' : '' ?> value="<?= $teacher->getMemberDetail->id ?>"> <?= $teacher->getMemberDetail->first_name . ' ' . $teacher->getMemberDetail->last_name ?> </option>
                                                                                    <?php
                                                                                }
                                                                            }
                                                                        }
                                                        ...
                                                        <div class="mt-2 text-center">
                                                            <button type="button" onclick="sendMessageToTeachers('<?= $current_id ?>')" class="btn btn-gradient btn-round btn-xl text-semibold">Send</button>
                                                        </div>
                                                    </form>
                                                </div> <!-- modal-body-->
                                            </div> <!-- modal-content-->
                                ...
                                <?php foreach ($not_chated as $ntchated) { ?>
                                    ...
                                    <div class="modal fade" id="modal_new_messages<?= $ntchated->id ?>" tabindex="-1" role="dialog" aria-labelledby="add_affiliation" aria-hidden="true">
                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title text-black" id="exampleModalLabel">New message To Studio Teachers <span class="text_maroon"> <?= $ntchated->first_name . ' ' . $ntchated->last_name; ?> </span></h6>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <i class="fas fa-times-circle"></i>
                                                    </button>
                                                </div>
...
//                                                $other_image = $pic;
//                                            }
//                                            if ($other_user->is_active && $chat->chat_type == 't') {
//                                                $chat_type_sidebar = 't';
                                                    ...
                                                    <div class="d-flex flex-row-reverse">
                                                        <figure>
                                                            ...
                                                            if ($message->message_type == 'g' && $message->group->admin_id == $current_id) {
                                                                ...
                                                                <?php
                                                            } elseif ($message->message_type == 't' && $message->studio->admin_id == $current_id) {
...
//                                                                    $pic = asset('public/images/' . $message->studio->pic);
                                                        ...
                                                        <div class="chat_body">
                                                            ...
                                                            <?php } elseif ($message->message_type == 't' && $message->studio->admin_id == $current_id) { ?>
...
//                                                if ($other_message_user->is_active && $message->message_type == 't') {
...
//                    return false;
                    ...
                    if (chat_type == 't') {
                        var chat_url = '<?= asset('teacher_studio_messages') ?>' + '/' + chat_group_id;
                    }
                    if (chat_type == 'u') {
...
//            if(data.other_id != current_id){
                ...
                if (data.user_id == current_id && data.to_be_show == 't') {
