                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="final_stats hover active" id="followers-statistics">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getFollowers ? thousandsNumberFormat($accompanist->getFollowers->where('created_at', '>=', \Carbon\Carbon::now()->subDay(11))->count()) : 0 ?></h2>
                                            <?php
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats hover" id="gigs-statistics">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getDoneBookings ? thousandsNumberFormat($accompanist->getDoneBookings->where('created_at', '>=', \Carbon\Carbon::now()->subDay(11))->count()) : 0 ?></h2>
                                            <?php
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats hover" id="reviews-statistics">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getReviews ? thousandsNumberFormat($accompanist->getReviews->where('created_at', '>=', \Carbon\Carbon::now()->subDay(11))->count()) : 0 ?></h2>
                                            <?php
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats hover" id="profile-statistics">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getProfileViews ? thousandsNumberFormat($accompanist->getProfileViews->where('created_at', '>=', \Carbon\Carbon::now()->subDay(11))->count()) : 0 ?></h2>
                                            <?php
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="final_stats" id="followers-statistics">
                                        <div class="label">Followers</div>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getFollowers ? thousandsNumberFormat($accompanist->getFollowers->count()) : 0 ?></h2>
                                            <?php
                                            $array_size = sizeof($followers_stats_data);
                                            if ($followers_stats_data[$array_size - 1] > $followers_stats_data[$array_size - 2]) {
                                                $class_name = 'fa-sort-up text_green';
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats" id="gigs-statistics">
                                        <div class="label">Gigs booked</div>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getDoneBookings ? thousandsNumberFormat($accompanist->getDoneBookings->count()) : 0 ?></h2>
                                            <?php
                                            $array_size = sizeof($gigs_stats_data);
                                            if ($gigs_stats_data[$array_size - 1] > $gigs_stats_data[$array_size - 2]) {
                                                $class_name = 'fa-sort-up text_green';
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats" id="reviews-statistics">
                                        <div class="label">Your reviews</div>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getReviews ? thousandsNumberFormat($accompanist->getReviews->count()) : 0 ?></h2>
                                            <?php
                                            $array_size = sizeof($reviews_stats_data);
                                            if ($reviews_stats_data[$array_size - 1] > $reviews_stats_data[$array_size - 2]) {
                                                $class_name = 'fa-sort-up text_green';
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats" id="reviews-statistics">
                                        <div class="label">Profile Views</div>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $accompanist->getReviews ? thousandsNumberFormat($accompanist->getProfileViews->count()) : 0 ?></h2>
                                            <?php
                                            $array_size = sizeof($views_stats_data);
                                            if ($views_stats_data[$array_size - 1] > $views_stats_data[$array_size - 2]) {
                                                $class_name = 'fa-sort-up text_green';
                            ...
                            <div class="stickysideRight"> 
                                ...
                                <div class="invite_group_scollarea">
                                    <ul id="invite_section" class="un_style invite_group_user">
                                        <?php
                                        $people_to_invite = getInviteUsers('a', $accompanist->id, 'studio_id');
                                        if (count($people_to_invite) > 0) {
                                            foreach ($people_to_invite as $invite) {
                                                ?>
                                                <li id="invite_a_<?= $invite->id ?>">
                                                    <a href="javascript:void(0)" class="d-flex align-items-center" onclick="inviteService('a', '<?= $accompanist->id ?>', '<?= $invite->id ?>')">
                                                        <div>
