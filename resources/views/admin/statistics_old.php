                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats hover" id="gigs-statistics">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $bookings ? thousandsNumberFormat($bookings->where('created_at', '>=', \Carbon\Carbon::now()->subDay(11))->count()) : 0 ?></h2>
                                            <?php
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats hover" id="reviews-statistics">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $studios ? thousandsNumberFormat($studios->where('created_at', '>=', \Carbon\Carbon::now()->subDay(11))->count()) : 0 ?></h2>
                                            <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="final_stats" id="gigs-statistics">
                                        <div class="label">Gigs booked</div>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <h2><?= $bookings ? thousandsNumberFormat($bookings->count()) : 0 ?></h2>
                                            <?php
                                            $array_size = sizeof($gigs_stats_data);
                                            if ($gigs_stats_data[$array_size - 1] > $gigs_stats_data[$array_size - 2]) {
                                                $class_name = 'fa-sort-up text_green';
