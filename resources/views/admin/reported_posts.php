                                                    ...
                                                    <form enctype="multipart/form-data" action="<?php echo asset('send_user_message'); ?>" method="post" >
                                                        ...
                                                        <div class="panel" style="padding-bottom: 10px;">
                                                            <div class="message_header">
                                                                <select id="users" data-placeholder="Choose a User..." class="chosen-select" multiple style="width:100%;" tabindex="4">
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input class="minimal" id="allusers" name="allusers" type="checkbox"> Send To All Users
                                                                </label>
                                                            </div>
                                                            <div class="message_footer">
                                                                <div>
                                                                    <input type="button" value="Send" class="msg_send_btn btn btn-primary" onclick="sendMail()">
                                                                </div>
                                                                <div class="clear"></div>
                                                            </div>
                                                        </div>
...
<!--                                                    <input data-status="" type="button" class="btn btn-primary reply" id="m_reply" data-userid="<?= $post_report->user->id ?>"
                                                        ...
                                                        <a href="#" class="reply" data-status="" id="m_reply" data-userid="<?= $post_report->post->user->id ?>" data-toggle="modal" data-target="#modal-default" value="Reply" data-id="">
        ...
        $('body').on('click', '.reply', function () {
            ...
            $('#test').find('.modal-body').append('<div class="col-sm-12">\
                    ...
                    <div class="modal-footer">\
                      ...
                      <button type="button" class="btn btn-primary send_email" data-id="' + id + '">Send</button>\
                    </div>\
                    ');
        });
