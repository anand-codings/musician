<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?=asset('admin_dashboard?signup_stats_filter=daily&deactivation_stats_filter=daily')?>" class="logo">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= asset('public/images/profile_pics/admin.png') ?>" class="user-image" alt="User Image">
                        <span class="hidden-xs">Administrator</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?= asset('public/images/profile_pics/admin.png') ?>" class="img-circle" alt="User Image">
                            <p>Administrator</p>
                        </li>
