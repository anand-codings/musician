...
<html>
    <head>
        ...
        <title>Comment Post Email</title>
            ...
            <tr>
                <td align="center" valign="top">
                    <table border="0" cellpadding="20" cellspacing="0" width="700" id="emailContainer" style="background: #fff">
                        <tr>
                            <td align="center" valign="top">
                                <a href="https://imgbb.com/"><img src="https://image.ibb.co/cjpK1y/logo5.png" alt="logo" border="0"></a>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top" style="color: #000;font-size:33px;font-weight: 500; font-family: 'Lato';padding: 30px 105px;">
                                Musician App comment on Post Email
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" style="color: #000;font-size:15px;font-family: 'Lato';line-height: 2.3;">
                                Hello <?= $othrername?>,<br>
                                <a href="<?= asset('profile_timeline/'.$other_id)?>"> <?= $name ?> </a> commented on your post.Click below to login
                            </td>

                        </tr>
                        <tr>
                            <td align="center" valign="top" style="color: #000;font-size:15px;font-family: 'Lato';padding: 35px 0;">
                                <a href="<?= asset('/get_post/'.$post_id) ?>" style="background: #7cc244;padding:14px 50px;color: #fff;text-decoration: none;border-radius: 5px;font-weight: bold;">View Post</a>
                            </td>
                        ...
                        <tr>
                            <td align="center" valign="top" style="color: #000;font-size:13px;font-family: 'Lato';padding-top: 0">
                                Support:<a href="mailto:Support@healingbudz.com" style="color: #000;font-size:15px;font-family: 'Lato';text-decoration: none;">Support@musician.com</a>
                            </td>

                        </tr>
                        <tr>
                            <td align="center" valign="top" style="color: #838383;font-size:13px;font-family: 'Lato';padding-top: 0;background: linear-gradient(0.45turn,#b22e66, #58248a);">
                                <table border="0" cellpadding="20" cellspacing="0" width="660" id="emailContainer">
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="color: #fff;font-size:13px;font-family: 'Lato';padding-top: 0;padding-bottom: 10px;">
                                            <a href="#" style="color: #fff;font-size:13px;font-family: 'Lato';text-decoration: none;">Copyright Musician 2018</a>  
