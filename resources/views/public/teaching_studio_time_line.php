                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xl-6 col-lg-9">
                            ...
                            <?php if (Auth::user()) { ?>
                                <div class="box box-shadow clearfix" id="post_box_studio_<?=$studio->id?>" <?=(Auth::user()->id == $studio->admin_id ||  (!empty($studio->checkMember) &&  $studio->checkMember->is_approved=='1'))?'':'style="display:none;"' ?>>
                                    ...
                                    <div class="modal-dialog modal-md" role="document">
                                        <div class="modal-content edit-event-popup">
                                            ...
                                            <div class="ml-auto d-flex">
                                                ...
                                                <input type="hidden" id="post_as" value="s_<?= $studio->id ?>">
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                success: function (response) {
                                                                    if (response.error) {
                                                                        ...
                                                                        if(response.file != ''){
                                                                            $('.studio_gallery_<?=$studio->id?>').children('ul').prepend('<li><a href="<?= asset('/') ?> '+ response.file +'" data-fancybox="gallery"><img src="<?= asset('/') ?>'+ response.file +'"></a></li>');
                                                                        } 
...
<?php } ?>
                                                ...
                                                function load_posts(skip, take) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data: {skip: skip, take: take, "post_type": "s", "post_type_col": "studio_id", "post_type_col_id": '<?= $studio->id ?>'},
                                                        success: function (response) {
                                                            $('#loaderposts').remove();
                                                            if (response) {
