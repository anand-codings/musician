                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xl-6 col-lg-9">
                            ...
                            <?php if (Auth::user()) { ?>
                                <div class="box box-shadow clearfix" id="post_box_accompanist_<?=$accompanist->id?>" <?=(Auth::user()->id == $accompanist->admin_id ||  (!empty($accompanist->checkMember) &&  $accompanist->checkMember->is_approved=='1'))?'':'style="display:none;"' ?>>
                                    ...
                                    <div class="modal-dialog modal-md" role="document">
                                        ...
                                        <div class="ml-auto">
                                            ...
                                            <input type="hidden" id="post_as" value="a_<?= $accompanist->id ?>">
                                            ...
                                            <div class="post_btns">
                                                ...
                                                <button class="btn-arrow font-14 drop-arrow">
                                                <span class=""><img src="<?php echo asset('userassets/images/down-arrow.png')?>"/></span>
                                                    <!-- <span class="loader_inline" id="post_loader" style="display: none;">
                                                        <img src="<?= asset('userassets/images/loader.gif') ?>" alt="loading.." />
                                                    </span> -->
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (response) {
                                                                if (response.error) {
                                                                    ...
                                                                    if(response.file != ''){
                                                                        $('.accompanist_gallery').children('ul').prepend('<li><a href="<?= asset('/') ?> '+ response.file +'" data-fancybox="gallery"><img src="<?= asset('/') ?>'+ response.file +'"></a></li>');
                                                                    } 
...
<?php } ?>
                                            ...
                                            function load_posts(skip, take) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    data: {skip: skip, take: take, "post_type": "a", "post_type_col": "accompanist_id", "post_type_col_id": '<?= $accompanist->id ?>'},
                                                    success: function (response) {
                                                        console.log(response);
                                                        $('#loaderposts').remove();
                                                        if (response) {
