                                    ...
                                    <nav class="nav create_post_option_btns">
                                        ...
                                        <?php if ($current_user->type == 'artist') { ?>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <select class="selectpicker show-tick" data-live-search="true" id="post_as">
...
<!--                                        <button id="submit_post" onclick="submitPost()" type="button" value="Post" class="btn btn-gradient btn-xl text-semibold btn_post_audio">
                                        Post <br/>
...
<?php } ?>
                                    ...
                                    function load_posts(skip, take) {
                                        ...
                                        $.ajax({
                                            type: "GET",
                                            url: "<?php echo asset('get_time_line'); ?>",
