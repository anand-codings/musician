...
<html lang="en">
    ...
    <body class="pt-0">
        <div class="loginpage flex-column">
                    ...
                    <div class="col-12">
                        <div class="login_box">
                            ...
                            <div class="l_r_side">
                                ...
                                <div class="social_btns clearfix">
                                    <a href="<?= asset('/facebook-login') ?>" class="btn btn-round btn-facebook"> <i class="icon-facebook"></i>Facebook </a>
                                    <a href="<?= asset('/google-login') ?>" class="btn btn-round btn-gplus"> <i class="icon-googleplus"></i> Google </a>
                                </div>
                                <?php
                                if ($errors->any()) {
                                ...
                                <form id="login_form" method="post" action="<?= asset('login') ?>">
                                    ...
                                    <div class="form-group">                                    
                                        <input name="email" type="email" class="form-control" placeholder="Email" value="<?php echo old('email'); ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="inputCall1" name="inputCheckboxesCall">
                                                    <label class="custom-control-label" for="inputCall1">Remember me</label>
                                                </div>
                                                <!--<span class="remember_me"><input na  type="checkbox" id="inputCall1" name="inputCheckboxesCall" class="peer">Remember me</span>-->
                                            </div>
                                            <div class="ml-auto">
                                                <span class="forget_password"><a href="<?php echo asset('forgetpassword'); ?>">Forget Password?</a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" value='Login' class='btn btn-round btn-red btn-submit' />
                                    </div>

                                    <div class="form-group">
                                        <div class="signup">Not member yet? <a href="<?php echo asset('register'); ?>">Sign up</a></div>
                                    </div>
                                </form>
                            </div>
                        </div>                       
