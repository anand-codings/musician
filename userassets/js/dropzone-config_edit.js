...
Dropzone.options.myDropzone = {
    ...
    init: function () {
        ...
        // Add server images
        var myDropzone = this;
        $.get('/musician/get_post_images/' + post_id, function (data) {
            $.each(data.images, function (key, value) {
                ...
                image_attachments.push({
                    ...
                    "db_name": value.original,
                    "poster": value.poster,
                    "db_thumb": value.db_thumb,
                    "type": value.type
                });
...
//            alert(myDropzone.options.maxFiles);
            $(document).ready(function () {
                ...
                if (image_attachments.length > 0 && image_attachments.length < 1) {
